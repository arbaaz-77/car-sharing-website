...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyCwX6uAVFe0aGilmgON8upNfaJ1r5UmQr8"></script>
      <style>
  ...
  <body>
      ...
      <div class="container-fluid" id="myContainer">
          <div class="row">
              <div class="col-md-6 col-md-offset-3">
                  ...
                  <p class="bold">You can save using car sharing!
                  </p>
                  <!--Search Form-->
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p> &copy; <?php $today = date("Y"); echo $today?>.</p>
          </div>
      </div>
